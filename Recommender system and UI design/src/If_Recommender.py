...
import Similarity_Calculate_IF
...
############################################
def basic_recommender(needed_user_name):
    ...
    #obtain the user's cluster members' IF
    IF_list=Data_PreProcessing.cluster_IF_search(user_name)
    #print IF_list
    ...
    specific_user_neighbor_similarity=Similarity_Calculate_IF.similarity_calculate(specific_user_rating_ary, specific_user_neighbor_star_ary, neighbor_id_list, average_rating_in_cluster,
                          IF_list)
    #####################################################################################
